...
// ─────────────────────────────────────────────────────────────────────────────
//
// TODO (backend): replace the local `propertiesData` lookup with a real fetch.
// Suggested shape using react-query, keyed by the route param:
//
...
//   );
//
// <PropertyLocationMap /> only needs { lat, lng, title } — no other refactor
// is required when you swap demo data for the API response.
//
// TODO (backend): nearby places, reviews, and landlord info can each become
// their own /api/.../{id} call:
//   - GET /api/properties/{id}/nearby   → replaces nearbyPlaces
//   - GET /api/properties/{id}/reviews  → replaces reviewsByProperty[id]
//   - GET /api/landlords/{landlordId}   → replaces landlordsData lookup
const propertiesData = [
  {
    id: 1, landlordId: 1, date: '2026-04-20',
    intent: 'rent', type: 'apartment', category: 'family', division: 'dhaka',
    title: 'Luxurious 4BHK Family Flat in Gulshan',
    location: 'Road 12, Gulshan 2, Dhaka',
    gpsLat: 23.7925, gpsLng: 90.4078,
    beds: 4, baths: 4, sqft: 2500, floor: 8, furnishing: 'Furnished',
    price: 120000, status: 'active',
    rating: 4.8, reviews: 124, verified: true, popularity: 95, inquiries: 7,
    coverPhoto: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200',
    roomPhotos: [
      { room: 'bedroom',  preview: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?q=80&w=800' },
      { room: 'bedroom',  preview: 'https://images.unsplash.com/photo-1540518614846-7eded433c457?q=80&w=800' },
      { room: 'bathroom', preview: 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?q=80&w=800' },
      { room: 'living',   preview: 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?q=80&w=800' },
      { room: 'kitchen',  preview: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?q=80&w=800' },
      { room: 'other',    preview: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=800' },
    ],
    mainVideo: null,
    videoId: 'O-P_J_gvALE',
    description: 'Experience unparalleled luxury in the heart of Gulshan. This meticulously designed 4-bedroom apartment offers stunning city views, Italian-marble kitchen, premium fixtures throughout, and 24/7 concierge. Floor-to-ceiling windows flood every room with natural light. Located steps from Gulshan Lake and top international restaurants.',
    amenities: ['Central AC', 'Parking', 'High-Speed WiFi', 'Generator Backup', '24/7 Security', 'Gym Access', 'Rooftop Lounge', 'CCTV'],
  },
  {
    id: 2, landlordId: 1, date: '2026-04-21',
    intent: 'rent', type: 'apartment', category: 'family', division: 'dhaka',
    title: 'Premium 3BHK Family Apartment in Banani',
    location: 'Block C, Banani, Dhaka',
    gpsLat: 23.7937, gpsLng: 90.4066,
    beds: 3, baths: 3, sqft: 1800, floor: 5, furnishing: 'Semi-Furnished',
    price: 85000, status: 'rented',
    rating: 4.5, reviews: 89, verified: true, popularity: 88, inquiries: 12,
    coverPhoto: 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?q=80&w=1200',
    roomPhotos: [
      { room: 'bedroom', preview: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?q=80&w=800' },
      { room: 'living',  preview: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=800' },
    ],
    mainVideo: null, videoId: 'O-P_J_gvALE',
    description: 'A beautifully crafted 3-bedroom apartment in the prime location of Banani.',
    amenities: ['Central AC', 'Parking', 'High-Speed WiFi', 'Generator Backup', '24/7 Security', 'CCTV'],
  },
  {
    id: 3, landlordId: 2, date: '2026-04-18',
    intent: 'purchase', type: 'flat', category: 'ready_flat', division: 'chittagong',
    title: 'Sea View Flat in Agrabad',
    location: 'Agrabad C/A, Chattogram',
    gpsLat: 22.3303, gpsLng: 91.8184,
    beds: 3, baths: 2, sqft: 1500, floor: 12, furnishing: 'Unfurnished',
    price: 4500000, status: 'active',
    rating: 4.7, reviews: 210, verified: true, popularity: 90, inquiries: 3,
    coverPhoto: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?q=80&w=1200',
    roomPhotos: [
      { room: 'living',   preview: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?q=80&w=800' },
      { room: 'bathroom', preview: 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?q=80&w=800' },
    ],
    mainVideo: null, videoId: 'O-P_J_gvALE',
    description: 'Wake up to breathtaking sea views from this pristine 3-bedroom flat in Agrabad.',
    amenities: ['Parking', 'Generator Backup', '24/7 Security'],
  },
  {
    id: 4, landlordId: 2, date: '2026-04-22',
    intent: 'rent', type: 'sublet', category: 'bachelor_male', division: 'dhaka',
    title: 'Modern Studio for Male Bachelors – Mirpur',
    location: 'Section 10, Mirpur, Dhaka',
    gpsLat: 23.8103, gpsLng: 90.3617,
    beds: 1, baths: 1, sqft: 420, floor: 3, furnishing: 'Furnished',
    price: 12000, status: 'active',
    rating: 4.2, reviews: 45, verified: true, popularity: 72, inquiries: 18,
    coverPhoto: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=1200',
    roomPhotos: [
      { room: 'bedroom', preview: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=800' },
    ],
    mainVideo: null, videoId: 'O-P_J_gvALE',
    description: 'A compact, fully furnished studio perfect for working professionals.',
    amenities: ['High-Speed WiFi', 'Generator Backup', '24/7 Security'],
  },
  {
    id: 8, landlordId: 1, date: '2026-04-25',
    intent: 'rent', type: 'apartment', category: 'family', division: 'dhaka',
    title: 'Sky Penthouse – Uttara Sector 13',
    location: 'Sector 13, Uttara, Dhaka',
    gpsLat: 23.8759, gpsLng: 90.3795,
    beds: 5, baths: 5, sqft: 4000, floor: 22, furnishing: 'Furnished',
    price: 250000, status: 'paused',
    rating: 4.9, reviews: 41, verified: true, popularity: 98, inquiries: 5,
    coverPhoto: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?q=80&w=1200',
    roomPhotos: [
      { room: 'bedroom',  preview: 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?q=80&w=800' },
      { room: 'bathroom', preview: 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?q=80&w=800' },
      { room: 'living',   preview: 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?q=80&w=800' },
    ],
    mainVideo: null, videoId: 'O-P_J_gvALE',
    description: 'The pinnacle of luxury living in Dhaka. This sky penthouse spans 4,000 sqft with a private terrace, infinity-edge jacuzzi, home theater, and 360° city panorama.',
    amenities: ['Rooftop Lounge', 'Gym Access', 'Central AC', 'Parking', 'Concierge'],
  },
];
...
const landlordsData = {
  1: {
    ...
    bio: 'A trusted premium property management firm in Dhaka since 2018. Specializing in family and executive apartments across Gulshan, Banani & Baridhara.',
    badges: ['Top Landlord 2026', 'Verified Business', 'Fast Responder'],
  },
  2: {
    id: 2, name: 'Karim Properties', tagline: 'Reliable Homes Across Dhaka & Chittagong',
    avatar: 'https://ui-avatars.com/api/?name=Karim+Properties&background=e8f5e9&color=2e7d32&size=256',
    rating: 4.7, totalReviews: 189, memberSince: '2019',
    responseRate: 95, responseTime: '< 2 hours', verified: true, totalProperties: 8,
    bio: 'Karim Properties offers quality rental homes across Dhaka and Chittagong.',
    badges: ['Verified Business', 'Fast Responder'],
  },
  3: {
    id: 3, name: 'Hossain Real Estate', tagline: 'Affordable Quality Rentals',
    avatar: 'https://ui-avatars.com/api/?name=Hossain+RE&background=fff3e0&color=e65100&size=256',
    rating: 4.3, totalReviews: 112, memberSince: '2020',
    responseRate: 90, responseTime: '< 4 hours', verified: false, totalProperties: 6,
    bio: 'Hossain Real Estate provides affordable, quality rentals for bachelors, students, and families.',
...
const reviewsByProperty = {
  1: [
    { id: 1, name: 'Nadia Islam', avatar: 'https://ui-avatars.com/api/?name=Nadia+Islam&background=e3f2fd&color=1565c0', rating: 5, date: '2026-03-15', comment: 'Absolutely stunning apartment. Management is top-notch and facilities are exactly as advertised. Lived here 6 months and love every day!' },
    { id: 2, name: 'Tariq Ahmed', avatar: 'https://ui-avatars.com/api/?name=Tariq+Ahmed&background=f3e5f5&color=6a1b9a', rating: 4, date: '2026-02-20', comment: 'Great location, great facilities. Landlord is very responsive. Minor water pressure issue was fixed same day.' },
    { id: 3, name: 'Sabrina Khan', avatar: 'https://ui-avatars.com/api/?name=Sabrina+Khan&background=fff3e0&color=e65100', rating: 5, date: '2026-01-10', comment: 'Best rental experience in Dhaka. Clean, secure, well-maintained. The rooftop lounge is a huge bonus!' },
  ],
};

// ─────────────────────────────────────────────────────────────────────────────
// NEARBY POIs — real Dhaka landmarks per category. Distances shown next to the
// property on the details page are computed from the property's gpsLat/gpsLng
// to the *nearest* POI in each category using the Haversine formula, so the
// numbers actually reflect where the property is — no more hard-coded fakes.
//
// TODO (backend): swap this curated catalogue for a live Google Places "Nearby
// Search" call:
//   GET /api/properties/{id}/nearby
//     → returns [{ category, name, lat, lng, distance_m, duration_min }]
//   or call Places API directly from the client behind a proxy:
//     places.nearbySearch({ location, radius: 1500, type: 'hospital' })
// `computeNearbyPlaces()` already returns the same shape the UI consumes, so
// the swap is a one-line change inside the useMemo below.
// ─────────────────────────────────────────────────────────────────────────────
const NEARBY_POI_CATALOG = {
  Hospital: [
    { name: 'Square Hospital',        lat: 23.7510, lng: 90.3856 },
    { name: 'United Hospital',        lat: 23.8025, lng: 90.4146 },
    { name: 'Apollo Hospitals Dhaka', lat: 23.8126, lng: 90.4253 },
    { name: 'Dhaka Medical College',  lat: 23.7257, lng: 90.3974 },
    { name: 'Labaid Specialized',     lat: 23.7466, lng: 90.3760 },
    { name: 'Ibn Sina Hospital',      lat: 23.7470, lng: 90.3727 },
    { name: 'Popular Diagnostic',     lat: 23.7490, lng: 90.3760 },
  ],
  School: [
    { name: 'Scholastica',            lat: 23.8196, lng: 90.4256 },
    { name: 'Sunbeams School',        lat: 23.7926, lng: 90.4067 },
    { name: 'Mastermind School',      lat: 23.7466, lng: 90.3727 },
    { name: 'Maple Leaf International',lat: 23.7466, lng: 90.3739 },
    { name: 'Aga Khan School',        lat: 23.8197, lng: 90.4226 },
    { name: 'Viqarunnisa Noon',       lat: 23.7344, lng: 90.4107 },
    { name: 'Notre Dame College',     lat: 23.7295, lng: 90.4126 },
  ],
  Market: [
    { name: 'Gulshan DCC Market',     lat: 23.7926, lng: 90.4145 },
    { name: 'Banani DCC Market',      lat: 23.7925, lng: 90.4078 },
    { name: 'New Market',             lat: 23.7335, lng: 90.3854 },
    { name: 'Karwan Bazar',           lat: 23.7510, lng: 90.3938 },
    { name: 'Mirpur 10 Bazar',        lat: 23.8068, lng: 90.3683 },
    { name: 'Bashundhara Mall',       lat: 23.7506, lng: 90.3924 },
    { name: 'Jamuna Future Park',     lat: 23.8133, lng: 90.4257 },
  ],
  Mosque: [
    { name: 'Baitul Mukarram',        lat: 23.7290, lng: 90.4127 },
    { name: 'Gulshan Azad Mosque',    lat: 23.7935, lng: 90.4105 },
    { name: 'Banani Bidyaniketan Masjid',lat: 23.7929, lng: 90.4046 },
    { name: 'Dhanmondi Eidgah Masjid',lat: 23.7466, lng: 90.3760 },
    { name: 'Mirpur Jame Masjid',     lat: 23.8068, lng: 90.3683 },
    { name: 'Uttara Sector 7 Masjid', lat: 23.8759, lng: 90.3795 },
  ],
  'Bus Stop': [
    { name: 'Gulshan-1 Bus Stop',     lat: 23.7800, lng: 90.4148 },
    { name: 'Banani Chairman Bari',   lat: 23.7937, lng: 90.4066 },
    { name: 'Dhanmondi 27',           lat: 23.7510, lng: 90.3760 },
    { name: 'Mirpur 10',              lat: 23.8068, lng: 90.3683 },
    { name: 'Uttara Sector 7',        lat: 23.8759, lng: 90.3795 },
    { name: 'Mohakhali Bus Terminal', lat: 23.7770, lng: 90.4053 },
    { name: 'Sayedabad Bus Terminal', lat: 23.7142, lng: 90.4262 },
  ],
  Park: [
    { name: 'Hatirjheel',             lat: 23.7558, lng: 90.4066 },
    { name: 'Ramna Park',             lat: 23.7376, lng: 90.4022 },
    { name: 'Dhanmondi Lake',         lat: 23.7466, lng: 90.3760 },
    { name: 'Gulshan Lake Park',      lat: 23.7926, lng: 90.4078 },
    { name: 'Chandrima Udyan',        lat: 23.7642, lng: 90.3784 },
    { name: 'Banani Park',            lat: 23.7926, lng: 90.4045 },
  ],
};

// Static labels + icons — drives the rendering order. Distance + nearest POI
// name are merged in by `computeNearbyPlaces()` below.
...
// For a given (lat, lng) origin, return the nearest POI in each category with
// its real distance — this is what the "Nearby" grid on the details page
// renders. Pure function so it's trivially testable + memo-friendly.
const computeNearbyPlaces = (lat, lng) => {
  const origin = { lat, lng };
  return NEARBY_PLACE_TYPES.map(({ label, icon }) => {
    const candidates = NEARBY_POI_CATALOG[label] || [];
    let nearest = null;
    let nearestKm = Infinity;
    for (const poi of candidates) {
      const d = haversineKm(origin, poi);
      if (d < nearestKm) { nearestKm = d; nearest = poi; }
    }
    return {
      label,
      icon,
      name: nearest ? nearest.name : null,
      distKm: nearestKm,
...
function buildGallery(property) {
  ...
  for (const roomId of GALLERY_ROOM_ORDER) {
    ...
    const photos = (property.roomPhotos || []).filter(p => p.room === roomId);
    photos.forEach(p =>
      items.push({ url: p.preview, room: roomId, label: rt?.label || roomId, emoji: rt?.emoji || '📷', Icon: rt?.Icon || Camera })
    );
  }
  return items;
}
...
const PropertyLocationMap = ({ lat, lng, title }) => {
  ...
  // Fallback (no API key OR loader error) → iframe embed (no key required).
...
const PropertyDetails = () => {
  ...
  const property = propertiesData.find((p) => String(p.id) === String(id)) || propertiesData[0];
  const landlord = landlordsData[property.landlordId] || landlordsData[1];
  ...
  const galleryImages = buildGallery(property);
  ...
  const [reviews, setReviews] = useState(reviewsByProperty[property.id] || []);
  ...
  // Compute the nearest hospital / school / market / etc. from THIS property's
  // coordinates, so the distances grid below the map is logically correct
  // (not the same hard-coded numbers for every listing). Replace this useMemo
  // with the Places API call described in the catalogue's TODO when the
  // backend is ready — no other JSX change required.
  const nearbyPlaces = useMemo(() => computeNearbyPlaces(mapLat, mapLng), [mapLat, mapLng]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-8 flex flex-col gap-5">
            ...
            <GlassCard className="p-5 md:p-7">
              ...
              {/* "Nearby" grid — distances are computed live from the property's
                  coordinates (see computeNearbyPlaces() above). Each tile shows
                  the actual closest landmark name + distance, so two listings
                  in different parts of the city no longer share identical
                  numbers. */}
            ...
            <motion.div
              ...
              {activeModal === 'call' && (
                <>
                  ...
                  <button
                    onClick={() => { setActiveModal(null); navigate('/messages', { state: { chatId: property.id, mode: 'call' } }); }}
              ...
              {activeModal === 'message' && (
                <>
                  ...
                  <button
                    onClick={() => { setActiveModal(null); navigate('/messages', { state: { chatId: property.id, mode: 'message' } }); }}
                    className="cyber-btn w-full text-white py-4 rounded-2xl font-black transition-all flex items-center justify-center gap-2"
                    style={{ background: 'linear-gradient(135deg, #ba0036 0%, #7c0026 100%)', boxShadow: '0 8px 22px rgba(186,0,54,0.22)' }}>
